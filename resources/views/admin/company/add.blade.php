...
@section('head')
<title>Dichungxe | Thêm Công Ty</title>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
               <form action="{{route('admin.company.add.post')}}" method="POST" enctype="multipart/form-data" id="myform">
                         ...
                         <!--     <a class="btn btn-sm btn-info " href="{{ URL::to('admin/companies') }}"> <i class="glyphicon glyphicon-circle-arrow-left"></i> Quay lại</a>
