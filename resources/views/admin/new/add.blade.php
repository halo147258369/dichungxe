...
@section('head')
<title>Dichungxe | Thêm Thành Phố</title>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form action="{{route('admin.news.add.post')}}" method="POST" enctype="multipart/form-data" id="myform">
                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                            
                            <div class="form-group form-group-sm">
                                <label>Tên tiêu đề <span class="error">(*) </span></label>
                                <input class="form-control" name="title" placeholder="Nhập tên tiêu đề" />
                            </div>
                            <div class="form-group">
                                <label>Tóm tắt</label>
                                <textarea name="summary" id="summary"  rows="2" cols="127"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Nội dung</label>
                                <textarea name="content" id="content"  rows="5" cols="127"></textarea>
                            </div>
