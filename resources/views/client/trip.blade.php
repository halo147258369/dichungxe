 ...
 <br>
      <div class="form-group form-group-sm"> 
            ...
            <div class="col-xs-6 col-md-3"><label for="email">Thành Phố:</label>
                  <select class="form-control" name="thanhpho"id="thanhpho" placeholder="Thành Phố" type="select"> 

                  </select>
           </div> 
           <div class="col-xs-6 col-md-3"><label for="email">Quận Huyên:</label>
                   <select class="form-control" name="quanhuyen"id="quanhuyen" placeholder="Quận Huyên" required="" type="select"> 
   
                 </select>
           </div> 
           <div class="col-xs-6 col-md-3"><label for="email">Phường Xã:</label> 
                    <select class="form-control" name="idDiemDi" id="phuong"placeholder="phuongxa" required="" type="select"> 
 @foreach($phuong as $p)
...
<br>
                           ...
                           <!--  <div class="form-group form-group-sm">
                             ...
                             <a class="btn btn-sm btn-info " href="{{ URL::to('admin/chuyendi/danhsach') }}"> <i class="glyphicon glyphicon-circle-arrow-left"></i> Quay lại</a>
   ...
   $.ajax({
      ...
      success: function( result )
      {
           $.each( result, function(k, v) {
                $('#quanhuyen').append($('<option>', {value:k, text:v}));
           });
      },
      error: function()
     {
...
$('#quanhuyen').change(function(){
   ...
   $.ajax({
      ...
      {
           $.each( result, function(k, v) {
                $('#phuong').append($('<option>', {value:k, text:v}));
           });
      },
      error: function()
     {
